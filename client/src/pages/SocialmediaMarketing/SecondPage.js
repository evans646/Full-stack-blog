...
export const SecondSocialMediaPage = () => {
  ...
  return(
     ...
     <div>
      <img src={CalenderPic} width={600} style={{marginLeft:'25%',padding:'0.5%'}} alt='calender'/>
      </div>
     <p>
...
<img src={QuestionPic} width={400} style={{marginLeft:'25%',padding:'0.5%'}} alt='sample questions'/>
<Container maxWidth='md'>
  <ul>
...
<ul>
   ...
   <div style={{marginTop:'2vh'}}>
     <Stack spacing={2}> 
     <Pagination count={2} variant="outlined" shape="rounded"  defaultPage={2}  onChange={()=> history.push('/featured/socialMediamrkting')}/>
   </Stack>
     </div>
      </div>
   </Container>
